...
public class Main extends JFrame {
        ...
        private void initComponents() {// GEN-BEGIN:initComponents
                ...
                pnlEntradaDadosLayout.setHorizontalGroup(
                                pnlEntradaDadosLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlEntradaDadosLayout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlEntradaDadosLayout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addGroup(pnlEntradaDadosLayout
                                                ...
                                                .addGroup(GroupLayout.Alignment.TRAILING, pnlEntradaDadosLayout
                                                                .createSequentialGroup()
                ...
                pnlTransladarLayout.setHorizontalGroup(
                                pnlTransladarLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladarLayout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlTransladarLayout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addGroup(pnlTransladarLayout
                                                                                                .createSequentialGroup()
                ...
                pnlTransladar1Layout.setHorizontalGroup(
                                pnlTransladar1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar1Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlTransladar1Layout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addGroup(pnlTransladar1Layout
                                                                                                .createSequentialGroup()
                ...
                pnlFuncTransLayout.setHorizontalGroup(
                                pnlFuncTransLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(GroupLayout.Alignment.TRAILING, pnlFuncTransLayout
                                                                .createSequentialGroup()
                                                                .addContainerGap(GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE)
                                                ...
                                                .addGroup(pnlFuncTransLayout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlFuncTransLayout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addComponent(jPanel1,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addGroup(pnlFuncTransLayout
                                                                                                .createSequentialGroup()
                                                                                                .addComponent(pnlTransladar,
                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                .addPreferredGap(
                                                                                                                LayoutStyle.ComponentPlacement.RELATED)
                                                                                                .addComponent(pnlTransladar1,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                Short.MAX_VALUE)))
                                                                .addContainerGap()));
                ...
                pnlTransladar2Layout.setHorizontalGroup(
                                pnlTransladar2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar2Layout.createSequentialGroup()
                                                                .addGap(15, 15, 15)
                                                                .addComponent(lblEDX14, GroupLayout.PREFERRED_SIZE, 129,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(edtFRDM1, GroupLayout.PREFERRED_SIZE, 145,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addContainerGap(68, Short.MAX_VALUE))
                                                .addGroup(pnlTransladar2Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addComponent(btnFRProxAE, GroupLayout.DEFAULT_SIZE,
                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE)
                                                                .addContainerGap()));
                pnlTransladar2Layout.setVerticalGroup(
                                pnlTransladar2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar2Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlTransladar2Layout.createParallelGroup(
                                                                                GroupLayout.Alignment.BASELINE)
                                                                                .addComponent(edtFRDM1,
                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(lblEDX14))
                                                                .addGap(18, 18, 18)
                                                                .addComponent(btnFRProxAE, GroupLayout.PREFERRED_SIZE,
                ...
                pnlTransladar3Layout.setHorizontalGroup(
                                pnlTransladar3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar3Layout.createSequentialGroup()
                                                                .addGap(15, 15, 15)
                                                                .addComponent(lblEDX15, GroupLayout.PREFERRED_SIZE, 129,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(edtFRDM2, GroupLayout.PREFERRED_SIZE, 145,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addContainerGap(68, Short.MAX_VALUE))
                                                .addGroup(pnlTransladar3Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addComponent(btnFRProx, GroupLayout.DEFAULT_SIZE,
                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE)
                                                                .addContainerGap()));
                pnlTransladar3Layout.setVerticalGroup(
                                pnlTransladar3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar3Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlTransladar3Layout.createParallelGroup(
                                                                                GroupLayout.Alignment.BASELINE)
                                                                                .addComponent(edtFRDM2,
                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(lblEDX15))
                                                                .addGap(18, 18, 18)
                                                                .addComponent(btnFRProx, GroupLayout.PREFERRED_SIZE, 35,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addContainerGap(43, Short.MAX_VALUE)));
                ...
                pnlTransladar4Layout.setHorizontalGroup(
                                pnlTransladar4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar4Layout.createSequentialGroup()
                                                                .addGap(15, 15, 15)
                                                                .addComponent(lblEDX16, GroupLayout.PREFERRED_SIZE, 149,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(
                                                                                LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(edtFRTM, GroupLayout.PREFERRED_SIZE, 145,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addContainerGap(GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE))
                                                .addGroup(pnlTransladar4Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addComponent(btnFRColisao, GroupLayout.DEFAULT_SIZE,
                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                Short.MAX_VALUE)
                                                                .addContainerGap()));
                pnlTransladar4Layout.setVerticalGroup(
                                pnlTransladar4Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlTransladar4Layout.createSequentialGroup()
                                                                .addContainerGap()
                                                                .addGroup(pnlTransladar4Layout.createParallelGroup(
                                                                                GroupLayout.Alignment.BASELINE)
                                                                                .addComponent(edtFRTM,
                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(lblEDX16))
                                                                .addGap(18, 18, 18)
                                                                .addComponent(btnFRColisao, GroupLayout.PREFERRED_SIZE,
                                                                                35, GroupLayout.PREFERRED_SIZE)
                ...
                pnlFuncTrans1Layout.setHorizontalGroup(
                                pnlFuncTrans1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(pnlFuncTrans1Layout.createSequentialGroup()
                                                                .addGroup(pnlFuncTrans1Layout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addGroup(pnlFuncTrans1Layout
                                                                                                .createSequentialGroup()
                                                                                                .addGap(284, 284, 284)
                                                                                ...
                                                                                .addGroup(pnlFuncTrans1Layout
                                                                                                ...
                                                                                                .addGroup(pnlFuncTrans1Layout
                                                                                                                .createParallelGroup(
                                                                                                                                GroupLayout.Alignment.LEADING,
                                                                                                                                false)
                                                                                                                .addComponent(pnlTransladar4,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                Short.MAX_VALUE)
                                                                                                                .addComponent(pnlTransladar3,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                Short.MAX_VALUE))))
                                                                .addContainerGap(GroupLayout.DEFAULT_SIZE,
                                                ...
                                                .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                .addGroup(layout.createParallelGroup(
                                                                                                                GroupLayout.Alignment.LEADING)
                                                                                                                .addComponent(pnlEntradaDados,
                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                                .addComponent(pnlFuncTrans,
                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.PREFERRED_SIZE))
                                                                                                .addGap(0, 0, Short.MAX_VALUE)
                                                                                                .addGroup(layout.createParallelGroup(
                                                                                                                ...
                                                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                                                ...
                                                                                                                                .addPreferredGap(
                                                                                                                                                ...
                                                                                                                                                174,
                                                                                                                                                Short.MAX_VALUE))
                                                                                                                .addComponent(pnlRadar,
                                                                                                                                GroupLayout.Alignment.TRAILING,
                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.PREFERRED_SIZE)))
                                                                                .addComponent(pnlFuncTrans1,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE))
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        private void grdDataMousePressed(MouseEvent evt) {// GEN-FIRST:event_grdDataMousePressed
                if (SwingUtilities.isRightMouseButton(evt)) {
                        ...
                        if (row >= 0) {
                                ...
                                int confirm = JOptionPane.showConfirmDialog(this, "Você deseja excluir este avião?",
        ...
        private JLabel getImage(Plane plane) throws IOException {
                ...
                Color planeColor = plane.getPlaneColor();
                if (planeColor == null) {
                        Random random = new Random();
                        planeColor = new Color(random.nextInt(256), random.nextInt(256), random.nextInt(256));
                        plane.setPlaneColor(planeColor);
                }
                ...
                for (int x = 0; x < resizedImg.getWidth(); x++) {
                        for (int y = 0; y < resizedImg.getHeight(); y++) {
                                int pixelColor = resizedImg.getRGB(x, y);

                                if ((pixelColor >> 24) != 0x00) {
                                        resizedImg.setRGB(x, y, planeColor.getRGB());
                                }
                        }
                }
